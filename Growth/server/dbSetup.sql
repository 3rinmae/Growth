...
CREATE TABLE IF NOT EXISTS sprints (
    id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP, updatedAt DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, name VARCHAR(255) NOT NULL, projectId INT NOT NULL, Foreign Key (projectId) REFERENCES projects (id) ON DELETE CASCADE
) default charset utf8 COMMENT '';