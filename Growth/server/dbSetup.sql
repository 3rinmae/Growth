...
CREATE TABLE IF NOT EXISTS tasks (
    id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, createdAt DATETIME DEFAULT CURRENT_TIMESTAMP, updatedAt DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, name VARCHAR(500) NOT NULL, weight TINYINT NOT NULL, isCompleted BOOLEAN NOT NULL DEFAULT false, assignedTo VARCHAR(255)
) default charset utf8 COMMENT '';